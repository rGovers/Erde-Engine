    ...
    public class Rigidbody : CollisionObject
    {
        ...
        public float Mass
        {
            ...
            set
            {
                ...
                {
                    Rigidbody_setMass(m_objectPtr, m_mass);
                }
            }
        }
        ...
        public Vector3 Force
        {
            get
            {
                ...
                if (m_objectPtr != IntPtr.Zero)
                {
                    Rigidbody_getForce(m_objectPtr, out x, out y, out z);
                }
        ...
        public Vector3 Torque
        {
            get
            {
                ...
                if (m_objectPtr != IntPtr.Zero)
                {
                    Rigidbody_getTorque(m_objectPtr, out x, out y, out z);
                }
        ...
        public override void ModifyObject ()
        {
            if (m_objectPtr != IntPtr.Zero)
            {
                ...
                Rigidbody_delete(m_objectPtr);
                m_objectPtr = IntPtr.Zero;
            }

            if (m_collisionShape != null)
            {
                m_objectPtr = Rigidbody_new(m_mass, IntPtr.Zero, m_collisionShape.Ptr);
        ...
        public void ApplyForce (Vector3 a_force)
        {
            if (m_objectPtr != IntPtr.Zero)
            {
                Rigidbody_applyForceCentral(m_objectPtr, a_force.X, a_force.Y, a_force.Z);
            }
        }
        public void ApplyForce (Vector3 a_force, Vector3 a_pos)
        {
            if (m_objectPtr != IntPtr.Zero)
            {
                Rigidbody_applyForce(m_objectPtr, a_force.X, a_force.Y, a_force.Z, a_pos.X, a_pos.Y, a_pos.Z);
            }
        }
        ...
        public void ApplyTorque (Vector3 a_torque)
        {
            if (m_objectPtr != IntPtr.Zero)
            {
                Rigidbody_applyTorque(m_objectPtr, a_torque.X, a_torque.Y, a_torque.Z);
            }
        }
        public void ApplyTorqueImpulse (Vector3 a_impulse)
        {
            if (m_objectPtr != IntPtr.Zero)
            {
                Rigidbody_applyTorqueImpulse(m_objectPtr, a_impulse.X, a_impulse.Y, a_impulse.Z);
            }
        }
        ...
        public void ApplyImpulse (Vector3 a_impulse)
        {
            if (m_objectPtr != IntPtr.Zero)
            {
                Rigidbody_applyImpulseCentral(m_objectPtr, a_impulse.X, a_impulse.Y, a_impulse.Z);
            }
        }
        public void ApplyImpulse (Vector3 a_impulse, Vector3 a_pos)
        {
            if (m_objectPtr != IntPtr.Zero)
            {
                Rigidbody_applyImpulse(m_objectPtr, a_impulse.X, a_impulse.Y, a_impulse.Z, a_pos.X, a_pos.Y, a_pos.Z);
            }
        }
    }
}
