...
class EDistanceFieldSphereAlgorithm : public btActivatingCollisionAlgorithm
{
private:
...
public:
    EDistanceFieldSphereAlgorithm(btPersistentManifold* a_mf, const btCollisionAlgorithmConstructionInfo& a_ci, const btCollisionObjectWrapper* a_col0Wrap, const btCollisionObjectWrapper* a_col1Wrap, bool a_swaped);
    EDistanceFieldSphereAlgorithm(const btCollisionAlgorithmConstructionInfo& a_ci);
    virtual ~EDistanceFieldSphereAlgorithm();
