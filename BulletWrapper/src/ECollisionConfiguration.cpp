...
EExport ECollisionConfiguration* __cdecl ECollisionConfiguration_new() { return new ECollisionConfiguration(); }
EExport void __cdecl ECollisionConfiguration_delete(ECollisionConfiguration* a_ptr) { delete a_ptr; }