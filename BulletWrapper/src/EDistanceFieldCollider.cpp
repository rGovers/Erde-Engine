...
EExport EDistanceFieldCollider* DistanceFieldCollider_new(void* a_distanceField, int a_stride, int a_width, int a_height, int a_depth, float a_spacing) { return new EDistanceFieldCollider(a_distanceField, a_stride, a_width, a_height, a_depth, a_spacing); }
EExport void DistanceFieldCollider_delete(EDistanceFieldCollider* a_ptr) { delete a_ptr; }